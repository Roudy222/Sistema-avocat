                ...
                <img src="../Assets/Imagenes/Escribir-Caso.png" alt="..." class="img-circle profile_img">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Remplissez les champs des entreprises du scenario<small></small></h2>
                                ...
                                <div class="x_content">
                                    <form class="" action="Esce_bd.php" method="POST" novalidate>
                                        ...
                                        <div class="field item form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <input class="form-control" class='optional' name="esce_Nombre"  type="text"></div>
                                        </div>
